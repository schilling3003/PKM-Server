...
| 24 | LightRAG integration: semantic retrieval, AI graph, and derived knowledge graph | child-lightrag (`devin/pkm-lightrag-integration`) | merged to `devin/pkm-lightrag-coord`; release-blocking edit-index regression fixed and verified, fresh critic/tester re-running | 6, 7, 15 |
...
6. Workstream 24 (LightRAG) replaces the pgvector-only search/ask/graph pipeline after workstreams 6, 7, and 15.
