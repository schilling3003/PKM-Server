...
| 24 | LightRAG integration: semantic retrieval, AI graph, and derived knowledge graph | child-lightrag (`devin/pkm-lightrag-integration`) | merged to `devin/pkm-lightrag-coord`; release-blocking edit-index regression fixed and verified; fresh Gauntlet critic PASS | 6, 7, 15 |
